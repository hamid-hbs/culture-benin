...
<div class="row align-items-center">
    <div class="col-sm-6">
        <h3 class="mb-0 fw-semibold text-dark">Liste des rôles</h3>
    </div>
...
<div class="card border-0 shadow-sm" style="border-radius: 12px;">
    ...
    <div class="card-body p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h5 class="mb-1 fw-semibold text-dark">Gestion des rôles</h5>
                <p class="text-muted small mb-0">{{ $roles->total() }} rôle(s) au total</p>
            </div>
            ...
            <table class="table table-hover table-bordered align-middle" style="border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #f1f3f5;">
                        <td class="ps-3 py-3">
                            <span class="fw-medium text-dark">{{ $role->nom }}</span>
                        </td>
                    ...
                    <tr>
                        <td colspan="2" class="text-center py-5">
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <p class="text-indigo-muted mb-0">Aucun rôle trouvé</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
        ...
        <div class="d-flex justify-content-between align-items-center mt-4 pt-3" style="border-top: 1px solid #f1f3f5;">
            <div class="text-muted small">
                Affichage de <strong>{{ $roles->firstItem() ?? 0 }}</strong> à <strong>{{ $roles->lastItem() ?? 0 }}</strong> sur <strong>{{ $roles->total() }}</strong>
            </div>
            <div>
