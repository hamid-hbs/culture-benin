...
<div class="row align-items-center">
    <div class="col-sm-6">
        <h3 class="mb-0 fw-semibold text-dark">Modifier une langue</h3>
    </div>
    ...
    <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
        ...
        <div class="card-body p-4 pb-2">
            <div class="mb-4">
                ...
                <p class="text-muted small mb-0">Modifiez les informations de cette langue ci-dessous.</p>
            </div>
            ...
            <form action="{{ route('langues.update', $langue->id) }}" method="POST">
                ...
                <div class="mb-3">
                    <label for="code" class="form-label fw-medium text-dark">Code de la langue</label>
                    <input type="text" 
                           name="code" 
                           id="code"
                ...
                <div class="mb-3">
                    <label for="nom" class="form-label fw-medium text-dark">Nom de la langue</label>
                    <input type="text" 
                           name="nom" 
                           id="nom"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" 
                              ...
                              rows="3"
                              placeholder="Une brève description optionnelle...">{{ old('description', $langue->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
