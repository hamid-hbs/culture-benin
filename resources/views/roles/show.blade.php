...
<div class="row align-items-center">
    <div class="col-sm-6">
        <h3 class="mb-0 fw-semibold text-dark">Détails du rôle</h3>
    </div>
...
<div class="container-fluid px-4">
    <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
        ...
        <div class="card-body p-4 pb-2">
            <div class="mb-4">
                <h5 class="mb-1 fw-semibold text-dark">{{ $role->nom }}</h5>
                <p class="text-muted small mb-0">Voici les informations détaillées sur ce rôle.</p>
            </div>

            <!-- Contenu des détails -->
            <div class="row g-3 mb-4">
                <div class="col-12">
                    <label class="form-label fw-medium text-dark">Nom du rôle</label>
                    <div class="p-3 bg-light rounded" style="border-left: 4px solid #0d6efd;">
                        <span class="fw-semibold text-dark fs-5">{{ $role->nom }}</span>
                    </div>
                </div>
            </div>
