...
<div class="row align-items-center">
    <div class="col-sm-6">
        <h3 class="mb-0 fw-semibold text-dark">Ajouter un utilisateur</h3>
    </div>
...
<div class="container-fluid px-4">
    <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
        ...
        <div class="card-body p-4 pb-2">
            <div class="mb-4">
                <h5 class="mb-1 fw-semibold text-dark">Formulaire d'ajout</h5>
                <p class="text-muted small mb-0">Remplissez les champs ci-dessous pour créer un nouveau utilisateur.</p>
            </div>
            ...
            <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <label for="nom" class="form-label fw-medium text-dark">Nom<span class="text-danger">*</span></label>
                        <input type="text" 
                               name="nom" 
                               id="nom"
                               class="form-control @error('nom') is-invalid @enderror" 
                               placeholder="Ex: BAWA SACCA"
                               value="{{ old('nom') }}"
                               required>
                        @error('nom')
                    ...
                    <div class="col-md-6">
                        <label for="prenom" class="form-label fw-medium text-dark">Prénom<span class="text-danger">*</span></label>
                        <input type="text" 
                               name="prenom" 
                               id="prenom"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" 
                               ...
                               placeholder="Ex: hamid@example.com"
                               value="{{ old('email') }}"
                               required>
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="id_langue" 
                            ...
                            @foreach($langues ?? [] as $langue)
                                <option value="{{ $langue->id }}" {{ old('id_langue') == $langue->id ? 'selected' : '' }}>{{ $langue->nom }}</option>
                            @endforeach
                        </select>
                        @error('id_langue')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-6">
                        <label for="mot_de_passe" class="form-label fw-medium text-dark">Mot de passe<span class="text-danger">*</span></label>
                        <input type="password" 
                               name="mot_de_passe" 
                               id="mot_de_passe"
                    ...
                    <div class="col-md-6">
                        <label for="mot_de_passe_confirmation" class="form-label fw-medium text-dark">Confirmer le mot de passe<span class="text-danger">*</span></label>
                        <input type="password" 
                    ...
                    <div class="col-12">
                        <label for="photo" class="form-label fw-medium text-dark">Photo de profil</label>
                        <input type="file" 
                               name="photo" 
                               id="photo"
