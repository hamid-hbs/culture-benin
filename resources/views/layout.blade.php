...
<html lang="en">
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <!-- MENU BODY (facultatif ou à remplacer) 
    <li class="user-body">
        <div class="row text-center">
            <div class="col-4"><a href="#">Profil</a></div>
            <div class="col-4"><a href="#">Stats</a></div>
            <div class="col-4"><a href="#">Activités</a></div>
        </div>
    </li>-->

    <!-- FOOTER -->
    <li class="user-footer d-flex justify-content-between">
        <a href="{{ route('users.show', Auth::user()->id) }}" class="btn btn-info">
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="light">
        ...
        <div class="sidebar-brand">
          ...
          <a href="/admin" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">Culture du Bénin</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
      ...
      <footer class="app-footer">
       ...
       <!--<div class="float-end d-none d-sm-inline">Anything you want</div>-->
        ...
        <strong>
          Copyright &copy; 2025&nbsp;
          <a href="/" class="text-decoration-none">Culture du Bénin</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
      </footer>
