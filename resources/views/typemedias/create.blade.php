...
<div class="row align-items-center">
    <div class="col-sm-6">
        <h3 class="mb-0 fw-semibold text-dark">Ajouter un type de média</h3>
    </div>
...
<div class="container-fluid px-4">
    <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
        ...
        <div class="card-body p-4 pb-2">
            <div class="mb-4">
                <h5 class="mb-1 fw-semibold text-dark">Ajouter un type de média</h5>
                <p class="text-muted small mb-0">Remplissez les champs ci-dessous pour créer un nouveau type de média.</p>
            </div>
