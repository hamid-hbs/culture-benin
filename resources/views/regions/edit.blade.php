...
<div class="row align-items-center">
    <div class="col-sm-6">
        <h3 class="mb-0 fw-semibold text-dark">Modifier une région</h3>
    </div>
    ...
    <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
        ...
        <div class="card-body p-4 pb-2">
            <div class="mb-4">
                ...
                <p class="text-muted small mb-0">Modifiez les informations de cette région ci-dessous.</p>
            </div>
            ...
            <form action="{{ route('regions.update', $region->id) }}" method="POST">
                ...
                <div class="mb-3">
                    <label for="nom" class="form-label fw-medium text-dark">Nom de la région</label>
                    <input type="text" 
                           name="nom" 
                           id="nom"
                ...
                <div class="mb-3">
                    <label for="description" class="form-label fw-medium text-dark">Description de la région</label>
                    <textarea name="description" 
                              id="description"
                              class="form-control @error('description') is-invalid @enderror" 
                              rows="3"
                              placeholder="Une brève description optionnelle...">{{ old('description', $region->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
